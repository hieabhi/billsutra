...
const Settings = () => {
  ...
  return (
    <div className="settings-page">
        ...
        {window.electronAPI && window.electronAPI.isElectron && (
          <button
            ...
            style={{
              padding: '12px 24px',
              border: 'none',
              background: activeTab === 'license' ? '#3b82f6' : 'transparent',
              color: activeTab === 'license' ? 'white' : '#6b7280',
              fontWeight: '600',
              borderRadius: '8px 8px 0 0',
              cursor: 'pointer',
              transition: 'all 0.2s'
      ...
      {/* License Tab (Desktop only) */}
      {activeTab === 'license' && window.electronAPI && window.electronAPI.isElectron && (
        <LicenseInfo />
      )}
